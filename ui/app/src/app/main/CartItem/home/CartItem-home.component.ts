...
@Component({
  selector: 'CartItem-home',
  templateUrl: './CartItem-home.component.html',
  styleUrls: ['./CartItem-home.component.scss']
})
export class CartItemHomeComponent implements AfterViewInit {
