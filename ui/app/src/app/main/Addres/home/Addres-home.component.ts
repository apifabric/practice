...
@Component({
  selector: 'Addres-home',
  templateUrl: './Addres-home.component.html',
  styleUrls: ['./Addres-home.component.scss']
})
export class AddresHomeComponent implements AfterViewInit {
