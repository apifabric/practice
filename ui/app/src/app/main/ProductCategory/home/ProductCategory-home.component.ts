...
@Component({
  selector: 'ProductCategory-home',
  templateUrl: './ProductCategory-home.component.html',
  styleUrls: ['./ProductCategory-home.component.scss']
})
export class ProductCategoryHomeComponent implements AfterViewInit {
